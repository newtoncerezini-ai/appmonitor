...
urlpatterns = [
    ...
    path("relatorios/exportar/csv/", ReportsCsvExportView.as_view(), name="reports_export_csv"),
    path("relatorios/exportar/pdf/", ReportsPdfExportView.as_view(), name="reports_export_pdf"),
